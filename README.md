...
<img src="https://komarev.com/ghpvc/?username=MossLouvan&label=Profile%20views&color=58a6ff&style=flat" alt="" />
...
|---|---|---|
| [Converge](https://github.com/jackulau/SwanHacksSpring2026) | SwanHacks 2026 winner — Canvas-synced AI study platform with a Remotion-rendered launch ad | React, TypeScript, Remotion |
| [Climbing Coach](https://github.com/MossLouvan/climbing-coach) | iPhone app that scores climbing biomechanics from video: pose → pseudo-3D → phase segmentation → coaching | Expo/React Native, on-device ML |
| [Moon Rover Portfolio](https://github.com/MossLouvan/3DPortfolioMossLouvan) | Interactive Three.js moon-rover scene driving my portfolio | Three.js, Vite |
